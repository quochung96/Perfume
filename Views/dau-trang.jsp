            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.html">Giỏ hàng: <span class="cart-amunt">${sessionScope.gioHang.tongTien()} đ</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">${sessionScope.gioHang.soMatHang()}</span></a>
                    </div>
                </div>
            </div>
        </div>
